// ===== app.js FULL CODE MỚI =====

// DANH SÁCH SẢN PHẨM (mỗi sản phẩm có ảnh riêng, tên riêng)
let products = [
...
<p>${item.price.toLocaleString()}đ x ${item.qty}</p>
